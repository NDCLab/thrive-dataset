...
expName = 'timestamp-v0'  # from the Builder filename that created this script
expInfo = {
    'id': '',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\NDCLab\\Desktop\\Experiments\\thrive\\timestamp-v0\\timestamp-v0_lastrun.py',
