...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\NDCLab\\Desktop\\Experiments\\thrive\\arrow-alert-v0 -trial_level_triggerLoss\\arrow-alert_v0_lastrun.py',
...
port = serial.Serial('COM4') #open specified port (COM4) for sending eeg triggers to   
...
for thisTask_condition_loop in task_condition_loop:
    ...
    for thisTask_block_loop in task_block_loop:
        ...
        for thisTask_trial_loop in task_trial_loop:
            ...
            routineForceEnded = False
            # update component parameters for each repeat
            # Run 'Begin Routine' code from trigger_loss_code_2
            # Kia: The following 2 lines are preventing the trigger loss
            port.close()
            port.open()
