...
expName = 'timestamp-v1-1'  # from the Builder filename that created this script
expInfo = {
    'id': '',
    'session': '1',
    'run': '1',
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\NDCLab\\Desktop\\Experiments\\THRIVE\\timestamp-v1-1\\timestamp-v1-1_lastrun.py',
...
image = visual.ImageStim(
    win=win,
    name='image', 
    image='stimuli/x-image.png', mask=None, anchor='center',
