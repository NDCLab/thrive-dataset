...
main_dir = '/home/data/NDClab/datasets/thrive-dataset'; %directory on the HPC

%% Setting up other things

%Location of MADE and ADJUSTED-ADJUST scripts
addpath(genpath([main_dir filesep 'code' filesep 'thrive_eeg']));% enter the path of the folder in this line
...
rawdata_location_parent = [main_dir filesep 'sourcedata' filesep 'raw' filesep 's1_r1' filesep 'eeg'];
...
%for file_locater_counter = 1:length(data_folder_lists) % This for loop lists the folders containing the main data files
for file_locater_counter = 4:-1:3
        rawdata_location = fullfile(rawdata_location_parent, data_folder_lists(file_locater_counter));
        rawdata_location = char(rawdata_location);

        % Enter the path of the folder where you want to save the processed data
        output_location = [main_dir filesep 'derivatives' filesep 's1_r1' filesep 'eeg' filesep 'preprocessed' ];
        % update the output_location
        output_location = fullfile(output_location, data_folder_lists(file_locater_counter));
