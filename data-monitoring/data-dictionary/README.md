...
* **expectedFileExt**: the file extensions expected for each data type, separated by commas; allowed (but not necessarily all expected) extensions can be separated by "\|"
